...
describe("Liquidation Problem 2", function () {
  it("2000 USDT", async function () {
    ...
    const USDT_debt = 2000;
    const USDT_contract_input = ethers.utils.parseUnits(USDT_debt.toString(), 6); // BigNumber (6 decimal)
    ...
    const liquidationTx = await liquidationOperator.operate(USDT_contract_input, (overrides = {gasPrice: gasPrice}));
